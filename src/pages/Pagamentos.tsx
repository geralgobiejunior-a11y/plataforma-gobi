...
import RecibosModal from '../components/pagamentos/RecibosModal';
...
if (ids.length > 0) {
  ...
  return (
    <div className="space-y-6">
      ...
      <RecibosModal
        open={recibosOpen}
        onClose={() => setRecibosOpen(false)}
        colaboradores={colaboradores.map((c) => ({
          id: c.id,
          nome_completo: c.nome_completo,
          foto_url: c.foto_url,
        }))}
        defaultCompetencia={periodo}
        defaultColaboradorId={colaboradorFilterId || ''}
      />
    </div>
  );
}
