...
export function Header({
  ...
  return (
    <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 transition-colors">
      <div className="h-1 w-full bg-gradient-to-r from-[#0B4F8A] via-[#0B4F8A] to-[#F5A623]" />
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={profileMenuRef}>
              ...
              >
                ...
                <div className="h-10 w-10 rounded-2xl bg-[#0B4F8A] dark:bg-[#0B4F8A] flex items-center justify-center shadow-sm">
              ...
              {showProfileMenu && (
                <div
                  className="absolute right-0 mt-2 w-64 rounded-2xl border border-slate-200 bg-white shadow-lg overflow-hidden
                             dark:border-slate-700 dark:bg-slate-900 dark:shadow-black/40 z-50"
                >
